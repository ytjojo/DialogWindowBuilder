...
public class RoundRectDrawableWithShadow extends Drawable {
    ...
    * */
    ...
    public RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius,
        ...
        mShadowStartColor = resources.getColor(R.color.dialog_shadow_start_color);
        mShadowEndColor = resources.getColor(R.color.dialog_shadow_end_color);
        mInsetShadow = resources.getDimensionPixelSize(R.dimen.dialog_compat_inset_shadow);
...
//            matrix.postScale(scaleX,scaleY,getBounds().left+getBounds().width()/2,
//                    getBounds().height()/2 + getBounds().top );
//            matrix.preTranslate(0,mTranslationY);
//            canvas.setMatrix(matrix);
//            canvas.translate(0,mTranslationY);
//            canvas.scale(scaleX,scaleY,getBounds().width()/2,getBounds().height()/2);
        }
    ...
    public static RoundRectDrawableWithShadow createBackground(Context context,
    ...
    public static RoundRectDrawableWithShadow initialize( Context context,
